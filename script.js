...
const testimonials = [
  ...
  {
    ru:{text:'MiMAX ичкенден кийин эртең менен жеңилирээк ойгонуп калдым. Теримдин өңү да жакшырып, чарчоо азайды.', name:'Гүлназ'},
    ky:{text:'MiMAX ичкенден кийин эртең менен жеңилирээк ойгонуп калдым. Теримдин өңү да жакшырып, чарчоо азайды.', name:'Гүлназ'}
  },
  {
    ru:{text:'GreenMAX курсунан кийин ичимдеги оордук азайды. Тамактануу режимин да оңой кармай баштадым.', name:'Нуриза'},
    ky:{text:'GreenMAX курсунан кийин ичимдеги оордук азайды. Тамактануу режимин да оңой кармай баштадым.', name:'Нуриза'}
  },
  {
    ru:{text:'NutriMAX менен кечки тамакты жеңилдеттим. Өзүмдү ток сезип, ашыкча жегеним азайды.', name:'Бактыгүл'},
    ky:{text:'NutriMAX менен кечки тамакты жеңилдеттим. Өзүмдү ток сезип, ашыкча жегеним азайды.', name:'Бактыгүл'}
  },
  {
    ru:{text:'BluMAXты үй-бүлөбүз менен колдондук. Суук тийген мезгилде организмимди жакшы колдогондой болду.', name:'Самат'},
    ky:{text:'BluMAXты үй-бүлөбүз менен колдондук. Суук тийген мезгилде организмимди жакшы колдогондой болду.', name:'Самат'}
  },
  {
    ru:{text:'FlexiMax боюнча кеңеш алып колдонуп көрдүм. Кыймылдаганда мурункудай оордук сезилбей калды.', name:'Жылдыз'},
    ky:{text:'FlexiMax боюнча кеңеш алып колдонуп көрдүм. Кыймылдаганда мурункудай оордук сезилбей калды.', name:'Жылдыз'}
  },
  {
    ru:{text:'Айсулуу түшүнүктүү айтып, кайсы продукт эмнеге керек экенин тактап берди. Заказ тез жетти.', name:'Асель'},
    ky:{text:'Айсулуу түшүнүктүү айтып, кайсы продукт эмнеге керек экенин тактап берди. Заказ тез жетти.', name:'Асель'}
  }
];
...
const i18n = {
  ...
  heroHalalText:{ru:'Вся продукция M-International сертифицирована и подходит для ежедневного применения.', ky:'M-International продукциясынын баары сертификатталган жана күн сайын колдонууга ылайыктуу.'},
  heroCertLabel:{ru:'Фото сертификатов', ky:'Сертификаттардын сүрөттөрү'},
  heroCertHalal:{ru:'Сертификат продукции', ky:'Продукция сертификаты'},
  heroCertQuality:{ru:'Контроль качества', ky:'Сапат көзөмөлү'},
  heroBtn1:{ru:'Смотреть каталог', ky:'Каталогду көрүү'},
  heroBtn2:{ru:'Написать в WhatsApp', ky:'WhatsApp\'ка жазуу'},
  heroResults:{ru:'Результаты продукции', ky:'Продукциянын жыйынтыктары'},
  heroCall:{ru:'Позвонить', ky:'Чалуу'},
  heroStatStudents:{ru:'учеников', ky:'окуучу'},
  heroStatProducts:{ru:'продуктов', ky:'продукт'},
  heroStatMarket:{ru:'на рынке', ky:'рынокто'},
  ...
  trust2:{ru:'Сертифицированная продукция', ky:'Сертификатталган продукция'},
  trust3:{ru:'Лицензия прямых продаж', ky:'Түз сатуу лицензиясы'},
  trust4:{ru:'Доставка по Кыргызстану', ky:'Кыргызстан боюнча жеткирүү'},
  aboutEyebrow:{ru:'О курсах и продукции', ky:'Курстар жана продукция жөнүндө'},
  aboutTitle:{ru:'Обучение и продукты — одна система роста', ky:'Окуу жана продуктылар — өсүүнүн бир системасы'},
  aboutLead:{ru:'M-International объединяет практические курсы, поддержку наставника и натуральную продукцию, чтобы вы могли развиваться, разбираться в направлении и подбирать решения для здоровья и красоты.', ky:'M-International практикалык курстарды, наставниктин колдоосун жана табигый продукцияны бириктирет, ошондуктан сиз өнүгүп, багытты түшүнүп, ден соолук жана сулуулук үчүн туура чечим тандай аласыз.'},
  ...
  ctNote:{ru:'Консультация доступна каждый день с 9:00 до 21:00.', ky:'Кеңеш берүү күн сайын 9:00дөн 21:00гө чейин жеткиликтүү.'},
