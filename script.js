...
const i18n = {
  ...
  heroHalalText:{ru:'Вся продукция M-International сертифицирована Halal и подходит для ежедневного применения.', ky:'M-International продукциясынын баары Halal сертификатына ээ жана күн сайын колдонууга ылайыктуу.'},
  heroCertLabel:{ru:'Фото сертификатов', ky:'Сертификаттардын сүрөттөрү'},
  heroCertHalal:{ru:'Halal сертификат', ky:'Halal сертификаты'},
