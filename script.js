...
const testimonials = [
  {
    ru:{text:'GreenMAX жана NutriMAX ичтим. Боордун майлануусу 3-даражадан 1-даражага түштү, бир жумада 3 кг арыктадым, шишиктер кетти — өзүмдү жеңил сезем!', name:'Татьяна'},
  ...
  {
    ru:{text:'GreenMAX, MiMAX жана BluMAX ичкен 9 күндө 1,5 кг салмак кетти, беттеги шишик басылды. Операциядан кийинки бут оорусу басылды, муундар ооруба калды.', name:'Максим'},
  ...
  {
    ru:{text:'Балама бронхиалдык астма коюлган — түнкүсүн MiMAX менен GreenMAX бердим. Төрт жылдан бери биринчи жолу дем кыстыгуусуз!', name:'Ирина'},
